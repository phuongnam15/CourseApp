import Tab4 from "@/app/tabs/(tabs)/setting";
...
import Tab1 from "../../app/tabs/(tabs)/index";
import Tab2 from "../../app/tabs/(tabs)/recommend";
import Tab3 from "../../app/tabs/(tabs)/roadmap";
    ...
    switch (routeName) {
      ...
      case "tab2":
        icon = (
          ...
          >
            <G fill={selectedTab === "tab2" && "#2E8B57"}>
      ...
      case "tab3":
        icon = (
          <Svg id="Capa_1" height={28} viewBox="0 0 512.001 512.001" width={28}>
            <Path
              fill={selectedTab === "tab3" && "#2E8B57"}
      ...
      case "tab4":
        icon = (
          <Svg
            ...
            width={28}
          >
            <G fill={selectedTab === "tab4" && "#2E8B57"} id="Icon">
              <G id="UserGear">
